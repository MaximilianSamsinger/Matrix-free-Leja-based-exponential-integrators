...
\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{1, \precision, overall, adv=\dif, dif=\adv}.pdf}
%	\caption{Remark: In this case $N$ is equal to the grid P\'eclet number $\operatorname{pe}$.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{1, \precision, grid, adv=\dif, dif=\adv}.pdf}
%	\caption{In this case $N$ is equal to the grid P\'eclet number $\operatorname{Pe}$.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{2, \precision, overall, adv=\dif, dif=\adv}.pdf}
%	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{2, \precision, grid, adv=\dif, dif=\adv}.pdf}
%	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{3, \precision, overall, adv=\dif, dif=\adv}.pdf}
%	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{3, \precision, grid, adv=\dif, dif=\adv}.pdf}
%	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{4, \precision, overall}.pdf}
%	\caption{A picture of a gull.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[]{../figures/Experiment1/{4, \precision, grid}.pdf}
%	\caption{A picture of a gull.}
\end{figure}
