...
%				+ \beta\ \vec{1}\cdot\nabla u^2 + u(u-0.5).
	...
	\begin{align} \label{eq:CFL}
		C_{dif} = \frac{2\alpha\tau}{h^2} \le \frac{1}{2}, \quad C_{adv} = \frac{\beta\tau}{h} \le 1.
	\end{align}
	This constraint can be seen in Figure \ref{fig:multi1DNonlinear} and INSERT OTHER FIGURE on the bottom row for the original problem. 
	
	\begin{figure}[h]
		\newcommand{\dif}{\detokenize{α}=0.1}
		\newcommand{\adv}{\detokenize{β}=1}
		\centering
		\includegraphics[width=0.9\columnwidth]{../Figures/Experiment2/multi, \dif, \adv.pdf}
		\caption{Comparison of different integrators for the one-dimensional case and the absolute tolerances \textit{half} ($\operatorname{tol} = 2^{-10}$) and single \textit{single} ($\operatorname{tol} = 2^{-24}$). We calculated the cost-minimizing time step size for each integrator, as shown in the bottom row. The top row displays the corresponding cost incurred. We chose $\alpha\dif$, $\beta\adv$. The dotted line indicates the maximal time step, where the CFL conditions are not violated.}
		\label{fig:multi1DNonlinear}
	\end{figure}
	
	
	\paragraph{Experiment setup}
	We considered $\alpha\in\{0.1,0.01\}$, $\beta\in\{1, 0.1, 0.01\}$ and $\operatorname{tol}\in \{2^{-10},2^{-24}\}$. For each integrator we compute the cost-minimizing time step sizes given $\alpha, \beta$ and an absolute tolerance $\operatorname{tol}$.
	...
	We consider the one-dimensional case see, Figure \ref{fig:multi1DNonlinear} and Appendix \ref{sec:1dim}. Despite these CFL constraints \ref{eq:CFL} \texttt{rk2} is a robust choice for all $\alpha$ and $\beta$ we considered. SEE APPENDIX. The 
...
%	\]
%	restricts the maximum possible step size for explicit Runge-Kutta methods. 
%	
...
\begin{itemize}
	\item Section 4.1 Erkläre warum $v=\sum_{j=1}^N v_j$ eine gute Wahl ist. (Gleichverteilung aller EV)
	\item Plots for CSR Matrix case		
	\item Appendix mit vielen Plots?
\end{itemize}
\begin{appendices}
...
\newcommand{\plotwidth}{0.9\columnwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment2/multi, \dif, \adv.pdf}
		%	\caption{Remark: In this case $N$ is equal to the grid P\'eclet number $\operatorname{pe}$.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment2/2, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment2/3, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment2/4, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
	
	\subsection{Nonlinear 2D case}
	{1, \precision, \dif, \adv}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment_2D/multi, \dif, \adv.pdf}
		%	\caption{Remark: In this case $N$ is equal to the grid P\'eclet number $\operatorname{pe}$.}
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment_2D/2, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment_2D/3, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\plotwidth]{../Figures/Experiment_2D/4, \precision, \dif, \adv.pdf}
		%	\caption{A picture of a gull.}
	\end{figure}
