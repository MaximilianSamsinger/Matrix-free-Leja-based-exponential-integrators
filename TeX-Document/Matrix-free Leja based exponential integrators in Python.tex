...
\subsection{Analysis of the power method}\label{poweritanalysis}
	...
	\[
		...
		= 2 I_{N,n}
	\]
	due to symmetry. Since $x\mapsto\sin^{4n}(x)$ is a $2\pi$-peroidic trigonometric polynomial of degree $4n$ the trapezoidal rule is exact if $2N>4n$. In general the error converges exponentially to $0$. For readers unfamiliar with these properties we refer to~\cite[Corollary 3.3]{trapezoidal}. 
...
\begin{thebibliography}{13}
	...
	\bibitem{scipy} P. Virtanen et al. SciPy 1.0: Fundamental Algorithms for Scientific Computing in Python. Nature Methods, in press.
