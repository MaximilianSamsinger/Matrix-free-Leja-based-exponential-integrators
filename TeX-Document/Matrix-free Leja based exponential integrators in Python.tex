...
%				+ \beta\ \vec{1}\nabla u^2 + u(u-0.5).
	...
	This constraint can be seen in Figure \ref{fig:multi1DNonlinear} on the bottom row for the original problem.
	\begin{figure}[h]
