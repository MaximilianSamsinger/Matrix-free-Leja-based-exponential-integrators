...
\begin{align*}
\partial_tu &= \partial_{xx}u + \frac{1}{\operatorname{Pe}}\partial_xu \quad t\in[0,0.1]\\
u_0(t) &= e^{-80\cdot(t-0,45)^2}
\end{align*}
with homogeneous Dirichlet boundary conditions on the domain $\Omega = [0,1]$. With $\operatorname{Pe}>0$ we denote the grid P\'eclet number.
