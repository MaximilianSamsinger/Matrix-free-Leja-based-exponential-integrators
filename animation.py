...
from Integrators import exprb2
...
if __name__ == '__main__':
    ...
    dif = 1e-1 # Multiply diffusion matrix with dif
    Pe = adv/dif
    A, u = AdvectionDiffusion1D(Nx, adv, dif, asLinearOp = False)
    u = u.flatten()
    ...
    exprb2.tol = [0,2**-24,2,2]
    exprb2.estKwargs = {}
    for k in range(Nt):
        y_list[k+1] += exprb2(A,y_list[k],t_list[k],t_list[k+1],1)[0]
